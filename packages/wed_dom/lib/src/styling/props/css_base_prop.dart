...
/// [CssBaseProp] is a base class for a CSS class property (obviously).
///
/// Implementations should override [name] and [value]
/// to provide the CSS property name and value.
/// {@endtemplate}
abstract class CssBaseProp {
  /// Creates an instance of [CssBaseProp].
  const CssBaseProp();
  ...
  CssStyleDeclaration toStyle() {
    final style = CssStyleDeclaration()..setProperty(name, value);
