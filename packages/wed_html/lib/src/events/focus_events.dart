...
/// Base Focus event.
class BaseFocusEvent extends HtmlEvents<FocusEvent> {
...
/// Focus event.
class OnFocus extends HtmlEvents<FocusEvent> {
...
/// Blur event.
class OnBlur extends HtmlEvents<FocusEvent> {
...
/// Focus in event.
class OnFocusIn extends HtmlEvents<FocusEvent> {
...
/// Focus out event.
class OnFocusOut extends HtmlEvents<FocusEvent> {
