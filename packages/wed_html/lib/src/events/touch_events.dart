...
/// Base Touch event.
class BaseTouchEvent extends HtmlEvents<TouchEvent> {
...
/// Touch start event.
class OnTouchStart extends HtmlEvents<TouchEvent> {
...
/// Touch move event.
class OnTouchMove extends HtmlEvents<TouchEvent> {
...
/// Touch end event.
class OnTouchEnd extends HtmlEvents<TouchEvent> {
...
/// Touch cancel event.
class OnTouchCancel extends HtmlEvents<TouchEvent> {
